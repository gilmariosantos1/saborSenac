...
CREATE TABLE `reserva_itens` (
  ...
  CONSTRAINT `fk_item_pessoa` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoas` (`id_pessoa`),
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `reservas_ibfk_1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoas` (`id_pessoa`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2026-05-02 22:35:34
